...
class University(models.Model):
  ...
  addtime = models.DateTimeField(auto_now_add=True,verbose_name=u'创建时间',default=datetime.now)
  province = models.ForeignKey(Province,verbose_name=u'大学省份')
...
class Education(models.Model):
  userdetail = models.ForeignKey(Userdetail,verbose_name=u'用户')
  university = models.ForeignKey(University,verbose_name=u'大学',blank=True,null=True)
  major = models.ForeignKey(Major,verbose_name=u'专业',blank=True,null=True)
